...
function inputSchema(schema: z.ZodType): object {
...
export const TOOL_DEFINITIONS = [
    {
        ...
        inputSchema: inputSchema(Schemas.AddEntitiesSchema)
    },
    {
        ...
        inputSchema: inputSchema(Schemas.AddObservationsSchema)
    },
    {
        ...
        inputSchema: inputSchema(Schemas.CreateRelationsSchema)
    },
    {
        name: "n2n_read_graph",
        ...
        inputSchema: inputSchema(Schemas.ReadGraphSchema)
    },
    {
        ...
        inputSchema: inputSchema(Schemas.GetGraphSummarySchema)
    },
    {
        ...
        inputSchema: inputSchema(Schemas.UpdateContextSchema)
    },
    {
        name: "n2n_search",
